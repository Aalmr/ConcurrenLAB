...
class EvaluaBloques extends Thread{
  int miId;
  double[] vectorX;
  double[] vectorY;
  int numHebras;
  int n;
  public EvaluaBloques(int miId, double[] vectorX, double[] vectorY, int numHebras, int n){
    this.miId=miId;
  ...
  public void run(){
    ...
    int principio = miId*elemsPorHebra;
    int fin = Math.min(n, principio + elemsPorHebra);
